...
static void LCD_InitPins(void){
	/*enable clock*/
	RCC->APB2ENR |= GPIOX_CLOCK(LCD_RS) | GPIOX_CLOCK(LCD_E) | GPIOX_CLOCK(LCD_D4) | \
					GPIOX_CLOCK(LCD_D5) | GPIOX_CLOCK(LCD_D6) | GPIOX_CLOCK(LCD_D7);
	/*Pinout configuration*/

	GPIOX_MODE(MODE_PP_OUT_10MHZ, LCD_RS);
	GPIOX_MODE(MODE_PP_OUT_10MHZ, LCD_E);
	GPIOX_MODE(MODE_PP_OUT_10MHZ, LCD_D4);
	GPIOX_MODE(MODE_PP_OUT_10MHZ, LCD_D5);
	GPIOX_MODE(MODE_PP_OUT_10MHZ, LCD_D6);
	GPIOX_MODE(MODE_PP_OUT_10MHZ, LCD_D7);
